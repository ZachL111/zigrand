"""Regression checks for the zigrand casebook."""
...
from casebook.harness import assert_expected, zigrand_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(zigrand_summary(), assert_expected())
